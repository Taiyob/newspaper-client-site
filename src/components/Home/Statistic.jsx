    ...
    <div className="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
      <section className="p-4 my-6 md:p-8 dark:bg-gray-800 dark:text-gray-100">
        <div className="container grid grid-cols-1 gap-6 m-4 mx-auto md:m-0 md:grid-cols-2 xl:grid-cols-3">
          <div className="flex bg-[#1F2937] overflow-hidden rounded-lg dark:bg-gray-900 dark:text-gray-100">
            <div className="flex bg-[#e5e7eb] items-center justify-center px-4 dark:bg-violet-400 dark:text-gray-800">
              <svg
