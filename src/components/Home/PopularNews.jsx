      ...
      <div className="bg-gray-50 py-4 hidden">
        <div className="xl:container mx-auto px-3 sm:px-4 xl:px-2">
          <div className="mx-auto table text-center text-sm">
            ...
            <a href="#">
              <img src="https://api.time.com/wp-content/uploads/2020/07/president-trump-coronavirus-election.jpg?quality=85&w=364&h=204&crop=1" alt="advertisement area" />
            </a>
          </div>
        </div>
      </div>
          ...
          <div className="flex flex-row flex-wrap">
            ...
            <div className="flex-shrink max-w-full w-full lg:w-1/2">
              <div className="box-one flex flex-row flex-wrap">
                <article className="flex-shrink max-w-full w-full sm:w-1/2 h-full mb-2 pr-2">
                  <div className="relative hover-img max-h-52 overflow-hidden">
                    <a href="#">
                      <img
                        className="max-w-full w-full mx-auto h-auto"
                        src="https://api.time.com/wp-content/uploads/2020/07/president-trump-coronavirus-election.jpg?quality=85&w=364&h=204&crop=1"
